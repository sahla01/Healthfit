    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          SizedBox(height: 3.7*SizeConfigure.heightMultiplier!),
          SizedBox(
            height: 18.5*SizeConfigure.heightMultiplier!,
            ...
            child: InkWell(
              ...
              child: Row(
                children: [
                  ...
                  SizedBox(width: 10.5*SizeConfigure.widthMultiplier!,),
              ...
              child: Row(
                children: [
                  Image.asset("assets/images/security.png",
                      height: 3.6*SizeConfigure.heightMultiplier!),
                  SizedBox(width: 5.2*SizeConfigure.widthMultiplier!,),
                  Column(
                    children: [
                      Padding(
          ...
          Padding(
            ...
            child: Row(
              children: [
                ...
                SizedBox(width: 3.0*SizeConfigure.widthMultiplier!,),
